...
function Notif.New(text, timee, type)
    ...
    frame_2.Size = UDim2.new(0, 400, 0, 0)
    ...
    frame_3.AnchorPoint = Vector2.new(1, 1)
    ...
    frame_3.Position = UDim2.new(1, 0, 1, 60)
    ...
    TS:Create(frame_3, TweenInfo.new(0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Position = UDim2.new(1, 0, 1, 0) }):Play()
    TS:Create(frame_2, TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), { Size = UDim2.new(0, 400, 0, 35) }):Play()
    ...
    local function close_notif()
        ...
        task.wait(0.17)
        TS:Create(frame_3, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.In), { BackgroundTransparency = 1, Position = UDim2.new(1, 0, 1, 60) }):Play()
        TS:Create(uistroke, TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.In), { Transparency = 1 }):Play()
        task.wait(0.05)
        TS:Create(frame_2, TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.In), { Size = UDim2.new(0, 400, 0, 0) }):Play()
        task.wait(0.2)
        frame_2:Destroy()
    end
